...
// Openclaw Easy fork: re-include "whatsapp" so it ships in the bundled
// DMG/EXE. Upstream excludes it because the plugin is large and intended
// for separate `openclaw plugins install`, but for the desktop app
// WhatsApp QR pairing is a marquee feature — without `dist/extensions/
// whatsapp/index.js` the smoke test fails and users can't connect WA at
// all. Mirrors the precedent in commit 29e4d394d7 (March 2026 sync).
