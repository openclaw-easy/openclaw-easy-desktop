...
// `moltbot-easy/` is the downstream private product that ships with this fork —
// it has its own duplication policy and shouldn't be cross-compared against the
// upstream openclaw source tree.
const intentionallyUnscannedPrefixes = [".agents/", "vendor/", "moltbot-easy/"];
